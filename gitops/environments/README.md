...
[`operator-values.yaml`](../operator-values.yaml) define immutable artifact
versions and digests once per Git revision. Each cluster promotes those pins
by selecting an approved revision.
